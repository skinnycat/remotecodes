...
<head>
   ...
   <link rel="stylesheet" href="styles/style.css"/>
    ...
    <body>
		...
		if(!(move_uploaded_file($_FILES['uploadedfile']['tmp_name'], "top5/top5.csv")) || !(move_uploaded_file($_FILES['manufile']['tmp_name'], "top5/manulist.csv"))) {
...
echo "<br><br>The file: [".  basename( $_FILES['manufile']['name'])."] has been uploaded successfully.<br><br>";
		    echo "File Size: ".(round(filesize($target_path)/1024,2))."Kb<br>\n";
        ?>
        <br>
        <form action="top5read.php" method="get">
            <button type="submit">Process top 5 Remote Codes</button>
        </form>
